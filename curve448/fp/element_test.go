...
func TestElementFixedExp(t *testing.T) {
	...
	const sqrtExponentElement = "3fffffffffffffffffffffffffffffffffffffffffffffffffffffffc0000000000000000000000000000000000000000000000000000000"
	...
	_bLegendreExponentElement, _ = new(big.Int).SetString("7fffffffffffffffffffffffffffffffffffffffffffffffffffffff7fffffffffffffffffffffffffffffffffffffffffffffffffffffff", 16)

	properties.Property("ExpByLegendreExp must match Exp(7fffffffffffffffffffffffffffffffffffffffffffffffffffffff7fffffffffffffffffffffffffffffffffffffffffffffffffffffff)", prop.ForAll(
		func(a testPairElement) bool {
			c := a.element
			d := a.element
	...
	_bCbrtExponentElement, _ = new(big.Int).SetString("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa9ffffffffffffffffffffffffffffffffffffffffffffffffffffffff", 16)

	properties.Property("ExpByCbrt2q1o3 must match Exp(aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa9ffffffffffffffffffffffffffffffffffffffffffffffffffffffff)", prop.ForAll(
		func(a testPairElement) bool {
			c := a.element
			d := a.element
			c.ExpByCbrt2q1o3(c)
...
func gen() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		if qElement[6] != ^uint64(0) {
			g.element[6] %= (qElement[6] + 1)
		}
...
func genFull() gopter.Gen {
	return func(genParams *gopter.GenParameters) *gopter.GenResult {
		...
		a[6], _ = bits.Add64(a[6], qElement[6], carry)
