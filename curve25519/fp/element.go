...
const qInvNeg = 9708812670373448219
...
func (z *Element) SetInterface(i1 any) (*Element, error) {
	if i1 == nil {
		return nil, errors.New("can't set curve25519fp.Element with <nil>")
	}
	...
	default:
		return nil, errors.New("can't set curve25519fp.Element from type " + reflect.TypeOf(i1).String())
	}
}
...
func (z *Element) SetBytesCanonical(e []byte) error {
	if len(e) != Bytes {
		return errors.New("invalid curve25519fp.Element encoding")
	}
	v, err := BigEndian.Element((*[Bytes]byte)(e))
	if err != nil {
		return err
...
var errInvalidEncoding = errors.New("invalid curve25519fp.Element encoding")
