...
// Package curve25519fp contains field arithmetic operations for modulus = 0x7fffff...ffffed.
//
// The API is similar to math/big (big.Int), but the operations are significantly faster (up to 20x).
//
// Additionally curve25519fp.Vector offers an API to manipulate []Element.
//
