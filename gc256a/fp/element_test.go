...
func TestElementFixedExp(t *testing.T) {
	...
	const sqrtExponentElement = "3fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff66"
	...
	_bLegendreExponentElement, _ = new(big.Int).SetString("7ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffecb", 16)

	properties.Property("ExpByLegendreExp must match Exp(7ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffecb)", prop.ForAll(
		func(a testPairElement) bool {
			c := a.element
			d := a.element
	...
	_bCbrtExponentElement, _ = new(big.Int).SetString("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa90f", 16)

	properties.Property("ExpByCbrt2q1o3 must match Exp(aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa90f)", prop.ForAll(
		func(a testPairElement) bool {
			c := a.element
			d := a.element
			c.ExpByCbrt2q1o3(c)
