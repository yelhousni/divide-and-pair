...
func TestElementFixedExp(t *testing.T) {
	...
	_bCbrtExponentElement, _ = new(big.Int).SetString("19c308bd25b13848eef068e557794c72f62a247271c6bf1c38e38e38aaaaaaab", 16)

	properties.Property("ExpByCbrt2QPlus1Div9 must match Exp", prop.ForAll(
		func(a testPairElement) bool {
			c := a.element
			d := a.element
			c.ExpByCbrt2QPlus1Div9(c)
