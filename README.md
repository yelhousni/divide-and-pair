...
| Curve | Field | Cofactor | d = gcd(h, p−1) | Halvings | Final check |
|-------|-------|----------|------------------|----------|-------------|
| **Ed25519** | p = 2²⁵⁵ − 19 | 8 | 4 | 1 | Quartic symbol |
| **Curve448** | p = 2⁴⁴⁸ − 2²²⁴ − 1 | 4 | 2 | 1 | Legendre symbol |
| **GC256A** | p = 2²⁵⁶ − 617 | 4 | 2 | 1 | Legendre symbol |
...
- **Quartic** (Ed25519 only): replaces one halving + Legendre with a single quartic residue symbol, computed via Weilert's Euclidean algorithm over Z[i].
- **QuarticExp** (Ed25519 only): same as Quartic but uses addition-chain exponentiation for the quartic symbol.
